...
class TestSkill extends TestCase
{
    private $client;
    ...
    {
        $response = $this->client->post('createSkill', [
            'headers' => [
    ...
    {
        $response = $this->client->get('readSkill?boutique_id=6', [
            'headers' => [
    ...
    {
        $response = $this->client->get('readSkill', [
            'headers' => [
    ...
    {
        $response = $this->client->post('updateSkill', [
            'headers' => [
                'Authorization' => "Bearer $this->validToken",
            ],
            'form_params' => [
    ...
    {
        $response = $this->client->delete('deleteSkill', [
            'headers' => [
                'Authorization' => "Bearer $this->validToken",
            ],
            'query' => [
