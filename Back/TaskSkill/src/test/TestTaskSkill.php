...
class TestTaskSkill extends TestCase
{
    private $client;
    ...
    {
        $response = $this->client->post('createTaskSkill', [
            'headers' => [
        ...
        $this->assertArrayHasKey('task_id', $responseBody[0]); // Exemple de vérification supplémentaire
        $this->assertEquals(2, $responseBody[0]["task_id"]);
    ...
    {
        $response = $this->client->get('readTaskSkill?boutique_id=6&skill_id=2&task_id=2', [
            'headers' => [
        ...
        $this->assertArrayHasKey('task_id', $responseBody[0]);
    ...
    {
        $response = $this->client->get('readTaskSkill', [
            'headers' => [
    ...
    {
        $response = $this->client->delete('deleteTaskSkill', [
            'headers' => [
                'Authorization' => "Bearer $this->validToken",
            ],
            'query' => [
